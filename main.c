...
static int read_device_cfg_info( void )
{
	...
	if(fp == NULL){
		...
		boardcfg.dev_mac[0] = 0xbc;
		boardcfg.dev_mac[1] = 0x9a;
		boardcfg.dev_mac[2] = 0x78;
		boardcfg.dev_mac[3] = 0x56;
		boardcfg.dev_mac[4] = 0x43;
		boardcfg.dev_mac[5] = 0x12;
...
int main(int argc,char *argv[])
{
	...
	printf("current version : software version 2017.10.22, hardware version 2016.10.22\n");
